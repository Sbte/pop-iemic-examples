...
from iemic import ( initialize_global_iemic, get_mask,depth_array_from_mask, 
                    get_surface_forcings, depth_levels, get_equilibrium_state, 
...
def reset_pop_state_from_iemic_state(pop, surface_state, iemic_state):
    ...
    channel1=surface_state.new_remapping_channel_to(pop.elements,  bilinear_2D_remapper)
