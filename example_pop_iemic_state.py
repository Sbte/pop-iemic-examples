...
if __name__ == "__main__":
    pop_interface = initialize_pop_with_iemic_setup()

    # plot_barotropic_streamfunction(pop_interface, "bstream-pop-iemic.eps")
    # plot_overturning_streamfunction(pop_interface, "mstream-pop-iemic.eps")
    # plot_salinity(pop_interface, "salinity-pop-iemic.eps")
    # plot_temperature(pop_interface, "temperature-pop-iemic.eps")
    ...
    # days = 0
    pop.plot_barotropic_streamfunction(pop_interface, "bstream-pop-iemic-v2-" + str(tend) + ".eps")
    pop.plot_overturning_streamfunction(pop_interface, "mstream-pop-iemic-v2-" + str(tend) + ".eps")
    pop.plot_salinity(pop_interface, "salinity-pop-iemic-v2-" + str(tend) + ".eps")
    pop.plot_temperature(pop_interface, "temperature-pop-iemic-v2-" + str(tend) + ".eps")
