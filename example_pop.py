...
if __name__ == "__main__":
    pop_interface = pop_iemic.initialize_pop()
    ...
    pop.plot_barotropic_streamfunction(pop_interface, "bstream-pop-" + str(tend) + ".eps")
    pop.plot_overturning_streamfunction(pop_interface, "mstream-pop-" + str(tend) + ".eps")
    pop.plot_salinity(pop_interface, "salinity-pop-" + str(tend) + ".eps")
    pop.plot_temperature(pop_interface, "temperature-pop-" + str(tend) + ".eps")
